...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>/app/Views/homeStyle.css">
    ...
    <div class="container general" style="width: 70%;">
        ...
        <div class="container">
            ...
            <div class="row mt-4">
                <div class="col-sm-6">
                    <div class="d-grid">
                        <a type="button" class="btn btn-lg btn-outline-dark" href="<?php echo base_url() ?>/index.php/socioController/create">Inscribirse</a>
                    </div>
                ...
                <div class="col-sm-6 text-end">
                    <div class="d-grid">
                        <a type="button" class="btn btn-lg btn-outline-warning" href="<?php echo base_url() ?>/index.php/socioController/mostrar">Mostrar socios</a>
            ...
            <div class="container text-center">
                <div class="row  align-items-center  imagenes">
                    <div class="col-sm-4 p-3">
                        <img src="<?php echo base_url() ?>/app/Views/img/balon.jpg" style="width: 88%;" alt="">
                    </div>
                    <div class="col-sm-4 p-3">
                        <img src="<?php echo base_url() ?>/app/Views/img/puntaso.jpg" style="width: 90%;" alt="">
                    </div>
                    <div class="col-sm-4 p-3">
                        <img src="<?php echo base_url() ?>/app/Views/img/locos.jpg" style="width: 90%;" alt="">
                    </div>
                </div>
            </div>
        </div>
